...
const accessCards = [
  {
    ...
    description:
      "Create an account, add patients, update routines, and manage emergency contacts from one shared care hub.",
  },
  {
    icon: KeyRound,
    title: "Patient Access",
    description:
      "Patients sign in with a caregiver-issued ID and can review routines, talk to the assistant, and save their day summary.",
  },
];
    ...
    <Layout>
      <section className="px-4 py-10 md:py-14 lg:py-16">
        <div className="container mx-auto max-w-6xl">
          <div className="grid items-start gap-6 xl:grid-cols-[minmax(340px,0.95fr)_minmax(460px,1.05fr)]">
            <div className="rounded-[2rem] bg-secondary/60 p-8 shadow-sm md:p-10">
              <div className="max-w-xl space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Caregivers manage patient records with email and password.
                    Patients use a caregiver-issued ID and no password.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
                {accessCards.map((card) => (
                  <div key={card.title} className="rounded-[1.75rem] border bg-card p-5">
            ...
            <div className="rounded-[2rem] border bg-card p-6 shadow-sm md:p-8 xl:p-10">
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() => setRole("caregiver")}
                  className={`rounded-[1.5rem] border-2 p-4 text-left transition-colors ${
                    role === "caregiver"
              ...
              {role === "caregiver" ? (
                <div className="mt-8">
                  ...
                  {isCaregiverSignUp ? (
                    <form className="grid gap-5 md:grid-cols-2" onSubmit={handleCaregiverSignUp}>
                      ...
                      <Button
                        className="md:col-span-2 h-14 text-lg"
                        size="lg"
                        type="submit"
                    ...
                    <form className="grid gap-5 md:grid-cols-2" onSubmit={handleCaregiverSignIn}>
                      <div className="space-y-2 md:col-span-2">
                        <label
                          className="text-sm font-medium"
                ...
                <div className="mt-8">
                  <div className="mb-6">
                    <h2 className="text-3xl font-bold">Patient sign in</h2>
                    <p className="mt-2 text-muted-foreground">
